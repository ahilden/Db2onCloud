...
- Verify that a supported driver is installed
   ...
   - Otherwise, install the Db2 driver package, which you can download from the https://www.ibm.com/support/pages/node/387577.
...
- [Lift (Legacy Plans Only)](https://www.lift-cli.cloud.ibm.com/#docs){:external}
